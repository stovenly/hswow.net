...
import { Collider } from '@engine/player/Collider';
import { Zone, OUTDOOR_ENVIRONMENT } from '@engine/world/Zone';
import { PortalGraph, arrivalFor, doorFacing, ARRIVAL_STANDOFF } from '@engine/world/Portal';
import { residentZones, KEEP_WITHIN } from '@engine/world/residency';
import { DEFAULT_REACH } from '@engine/world/Interaction';
import { noteById } from '@engine/world/notes';
import { NOTES } from '../code/notes';
import { buildDoor, doorMetrics, doorName } from '@engine/art/door';
import { markCollidable } from '@engine/player/Collider';
import { createTestWorld, ZONE_EXTERIOR } from '../code/zones';
import { ZONE_DEMOS } from '../code/demos';
import { ZONE_FOOTSTEPS_SHOWCASE } from '../code/FootstepsShowcase';
import { GROUND, COVER_TYPES } from '@engine/world/ground';
import { COVER_ATTRIBUTE, coverCensus } from '@engine/art/cover';
import { groundcoverTerrain, ZONE_GROUNDCOVER_SHOWCASE } from '../code/GroundcoverShowcase';
import { ZONE_PARTICLE_SHOWCASE } from '../code/ParticleShowcase';
import { drawnAlpha, QUANTIZE_FLOOR } from '@engine/art/particles';
import {
  clampFog,
  resolveSamples,
  DEFAULT_RENDER,
  FOG_HEADROOM,
  VIEW_UNLIMITED,
} from '@engine/engine/PostFX';
import { PixelStage, FLAT_NORMAL } from '@engine/engine/PixelStage';
import { buildInterior, HOUSE_STYLE } from '@engine/world/interior';
import { DETAIL_ATTRIBUTE, DETAIL_TINT_ATTRIBUTE } from '@engine/art/detail';
import { SKY_FRACTION } from '@engine/engine/Sky';
import { CAMERA_FAR } from '@engine/engine/Viewport';
import { SURFACES } from '@engine/audio/models/footsteps';
import { ProvingGround } from '../code/ProvingGround';
import { countrysideTerrain, ZONE_COUNTRYSIDE } from '../code/countryside-village';
...
import { doorDuration, DOOR_SPECS, type DoorMaterial } from '@engine/audio/models/door';
 ...
 */
{
  // Sampled counts are the ultra pool; the default tier draws 0.3 of it.
