...
import { countrysideTerrain, COUNTRYSIDE_GATE, ZONE_COUNTRYSIDE } from './countryside-village';
  ...
  return [
    {
      ...
      b: {
        ...
        // In the arch on the village's boundary, dropped onto the ground. The
        // arrival marker is derived a stride in front of this, inside the wall.
