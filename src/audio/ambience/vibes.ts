...
export const PLAINS_2_AMBIENCE: AmbienceSpec = {
  ...
  chorus: [
    ...
    { model: 'insect', options: { kind: 'grasshopper', voices: 3, gain: 0.045 }, follow: [{ by: 'activity', span: [0.2, 1] }], when: { sun: [6, 90], season: [0.4, 0.78], warmth: [16, 40] } },
  ],
  cast: [
    { voice: 'curlew', every: [20, 60], height: 3, when: { season: [0.22, 0.62], sun: [-10, 90] } },
    { voice: 'plover', every: [26, 80], height: 2, when: { season: [0.25, 0.6], sun: [-8, 90] } },
    { voice: 'snipe', every: [26, 80], height: 12, when: { season: [0.25, 0.55], sun: [-10, 5] } },
    { voice: 'lapwing', every: [32, 90], height: 6, passes: { over: 50, seconds: [2, 4] }, when: { season: [0.2, 0.55], sun: [-6, 90] } },
    { voice: 'stonechat', every: [26, 80], height: 1.2, when: { sun: [0, 90], season: [0.25, 0.75] } },
    { voice: 'linnet', every: [32, 90], height: 1.5, when: { season: [0.3, 0.74], sun: [2, 90] } },
    { voice: 'wings', every: [45, 130], height: 2, level: 0.8 },
