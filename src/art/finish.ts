  ...
  material.onBeforeCompile = (shader, renderer) => {
    ...
    shader.vertexShader = shader.vertexShader
      .replace(
        ...
        /** 1 in open sun, down to 1 − strength under the low deck. Per vertex: a shadow is a shape on the ground. */
        varying float vFinishCloud;
      ...
      .replace(
        ...
        vFinishCloud = uFinishSky > 0.5
          ? cloudShadowAt((modelMatrix * vec4(transformed, 1.0)).xyz, normalize(uSunDirection))
          : 1.0;
        {
